/**
 * Verify Email OTP Template
 * Brand-matched HTML email for Workflow Orchestrator
 */

export function getVerifyEmailHtml(username, otp) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
          ...
          <tr>
            <td style="padding:40px 40px 16px 40px;">
              ...
              <p style="margin:0 0 28px 0;font-size:15px;color:#64748b;line-height:1.6;">
                Hi <strong style="color:#0f172a;">${username}</strong>, welcome to Workflow Orchestrator! 
                Use the verification code below to confirm your email and get started.
              </p>
            </td>
          </tr>
                ...
                <tr>
                  <td style="padding:14px 18px;">
                    <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.5;">
                      ⏱ This code is valid for a limited time. If it expires, you can request a new one from the sign-up page.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:24px 40px 32px 40px;">
              <p style="margin:0 0 4px 0;font-size:13px;color:#94a3b8;line-height:1.5;">
                You received this email because you signed up for <strong style="color:#64748b;">Workflow Orchestrator</strong>.
              </p>
              <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.5;">
